...
food_categories = {
    ...
    "Pizza Corner": ["Margareta", "Sales 24-7 Deluxe Pizza", "Hawii PIzza", "Regina Pizza", "Vegetarian Pizza", "Chicken Pizza", ],
...
Manager
user = User("samit", "123")
manager = Manager("Samuel", "Itwaru", "samuelitwaru@yahoo.com",
                  "samuelitwaru@yahoo.com", user)
...
# Kitchen Stock
kitchen_stock = [("Ginger", "Kilograms"), ("Oil", "Litres"),
                 ("Tomatoes", "Pieces"), ("Onions", "Pieces"), ("Cabbage", "Heads")]
...
for food_category, foods in food_categories.items():
    ...
    for food in foods:
        Food(food, choice(range(15, 100)), "Plate",
             choice(range(1000, 40000, 500)), cat)
